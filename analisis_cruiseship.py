...
# =============================================================================
#  NORMALIZATION INTO STAR SCHEMA
# =============================================================================
titulo("PASO- NORMALIZE INTO STAR SCHEMA")
...
ships_dim = (
    ...
    .drop_duplicates(ignore_index=True) # subset=  [] y keep first 
...
bookings_fact = df[
    [
        ...
        "price_category",                   # <--- Nueva columna categórica
        

        # Guest spending
        "average_daily_guest_spending_usd",
        "total_guest_spending_usd",         # <--- Nueva columna calculada
